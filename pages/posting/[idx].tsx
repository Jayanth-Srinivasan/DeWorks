  ...
  useEffect(() => {
    if (isConnected && idx) {
      getJobById(Number(idx)).then((data) => {
        /* @ts-ignore */
        setPost({ ...data, formatedMatic: formatEther(data.payInMATIC) });
      });
    }
  }, [address, idx]);
    ...
    <>
      ...
      <main className="h-full bg-[url('/assets/line-bg.png')] w-full font-outfit bg-app-grey-dark text-stone-200">
        ...
        <section className="p-4 flex flex-col md:px-16 lg:flex-row gap-6 max-w-7xl mx-auto pb-[50px] md:pb-[80px]">
          <div>
            <h2 className="text-2xl lg:text-4xl font-bold">Job Description</h2>
            ...
            <ul className="list-disc">
              {benefits.map((benefits, idx) => (
                <li key={idx} className="mt-2 text-slate-200 md:text-lg ml-4">
                  {benefits}
                </li>
              ))}
            </ul>
            ...
            <h2 className="text-2xl lg:text-4xl font-bold mt-4">Benefits</h2>
            <ul className="list-disc">
              {benefits.map((benefits, idx) => (
                <li key={idx} className="mt-2 text-slate-200 md:text-lg ml-4">
                  {benefits}
          ...
          <div className="">
            <div className="w-full h-fit bg-app-grey-light border border-white/20 rounded p-4 md:min-w-[400px] lg:sticky top-24">
              <h2 className="text-2xl lg:text-4xl font-bold">Overview</h2>
